...
public class HistogramEQ {
    ...
    public static void main(String[] args) throws IOException {
        ...
        File original_f = new File("./resources/roi101.png");
        String output_f ="./resources/eq.png";
        original = ImageIO.read(original_f);
        equalized = histogramEqualization(original);
        ImageUtils imageUtils= new ImageUtils();
//        imageUtils.displayImage(imageUtils.bufferImageToMat(original,BufferedImage.TYPE_3BYTE_BGR));
//
//        imageUtils.displayImage(imageUtils.bufferImageToMat(equalized,BufferedImage.TYPE_3BYTE_BGR));
